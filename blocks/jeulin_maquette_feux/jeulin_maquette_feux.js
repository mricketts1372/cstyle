...
Blockly.Blocks['jeulin_detection_luminosite_ldr1'] = {
  init: function() {
    ...
    this.appendDummyInput("")
        ...
        .appendField(new Blockly.FieldImage("http://gdriv.es/ptcbimages/solutions-48.png" , Blockly.Arduino.imageSize, Blockly.Arduino.imageSize));
  this.appendDummyInput()
   .appendField(Blockly.Msg.TECHNOZONE51_TEXT2)
...
Blockly.Blocks['jeulin_feux_voie2_led1green'] = {
  init: function() {
    ...
    this.appendDummyInput("")
        ...
        .appendField(new Blockly.FieldImage( Blockly.Arduino.imageSize, Blockly.Arduino.imageSize))
    this.appendValueInput("PIN", 'Number')
        .setAlign(Blockly.ALIGN_RIGHT)
        .appendField(Blockly.Msg.TECHNOZONE51_TEXT2)
    this.setPreviousStatement(true, null);
