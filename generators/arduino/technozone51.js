...
Blockly.Arduino.technozone_btn1white = function() {
   var dropdown_pin_custom= this.getFieldValue('PIN');
  Blockly.Arduino.setups_['setup_btn1white_'+dropdown_pin_custom] = 'pinMode('+dropdown_pin_custom+', INPUT);';
  var code = 'digitalRead('+dropdown_pin_custom+')==0';
  return [code, Blockly.Arduino.ORDER_ATOMIC];
};
